...
namespace WebScraper
{
    public partial class Form1 : Form
    {
        ...
        /// </summary>
        private async void scrapeButtonClickAsync(object sender, EventArgs e)
        {
            // Reset some stuff
            ...
            charCountBox.Text = lengths.Sum().ToString();
        ...
        /// </summary>
        private async Task<int> scrapeTagsAsync(string url)
        {
            // Get the web page in an synchronous fashion
